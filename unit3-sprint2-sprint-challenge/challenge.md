...
Answer: The relationship is Single/one(employee) to multiple/many(territories). Employees have more than one territory, but territories do not have more than one employee

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
Answer: MongoDB is suitable for projects that require:the ability to be document oriented, high performance, replication, high scalability, no rigid schema,heterogeneous data,distribution,JSON,easy integration

MongoDB is not a good fit for Ecommerce product catalog, high-speed logging,blogs, high scalability.


- What is "NewSQL", and what is it trying to achieve?
Answer : NewSQL works on improving scalability while also maintaining CID guarantees. This is mostly useful for online transaction processing because it permits us to have large amount of transactions but still have a guarantee that the data should be valid in case of errors etc.
